	...
	<div id="container">
		...
		<div class="location_area member">
			<div class="box_inner">
				...
				<p class="location">MEMBER <span class="path">/</span> CONTENTS</p>
		...
		<div class="bodytext_area box_inner">
			...
			<form action="/board/write" class="appForm" method="post" encType="multipart/form-data">
				<fieldset>
					...
					<p class="btn_line">						
						<button type="submit" class="btn_baseColor">SUBMIT</button>
						<button onclick="location.href='/board/list'" class="btn_baseColor">LIST ALL</button>	
					</p>
				</fieldset>
			</form>
			<!-- //appForm -->
