<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- http://spring-edu.herokuapp.com/admin/board/listAll -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper" style="min-height: 1186px;">
...
<table class="table table-bordered">
	...
	<tr>
		<td>5</td>
		<td><a href="/admin/board/read?page=1&amp;perPageNum=10&amp;searchType&amp;keyword&amp;bno=5">새로운 글을 넣습니다. &nbsp;<strong>[ 0 ]</strong></a></td>
		<td>user00</td>
		<td>2019-10-10 03:26</td>
	...
	<tr>
		<td>4</td>
		<td><a href="/admin/board/read?page=1&amp;perPageNum=10&amp;searchType&amp;keyword&amp;bno=4">새로운 글을 넣습니다. &nbsp;<strong>[ 0 ]</strong></a></td>
		<td>user00</td>
		<td>2019-10-10 03:26</td>
	...
	<tr>
		<td>3</td>
		<td><a href="/admin/board/read?page=1&amp;perPageNum=10&amp;searchType&amp;keyword&amp;bno=3">새로운 글을 넣습니다. &nbsp;<strong>[ 0 ]</strong></a></td>
		<td>user00</td>
		<td>2019-10-10 03:25</td>
		<td><span class="badge bg-red">0</span></td>
	</tr>
	...
	<tr>
		<td>2</td>
		<td><a href="/admin/board/read?page=1&amp;perPageNum=10&amp;searchType&amp;keyword&amp;bno=2">새로운 글을 넣습니다. &nbsp;<strong>[ 0 ]</strong></a></td>
		<td>user00</td>
		<td>2019-10-10 03:25</td>
		<td><span class="badge bg-red">0</span></td>
	</tr>
	...
	<tr>
		<td>1</td>
		<td><a href="/admin/board/read?page=1&amp;perPageNum=10&amp;searchType&amp;keyword&amp;bno=1">수정된 글입니다.&nbsp;<strong>[ 1 ]</strong></a></td>
		<td>user00</td>
		<td>2019-10-10 03:20</td>
		<td><span class="badge bg-red">0</span></td>
	</tr>
				...
				<div class="text-center">
					<ul class="pagination">
							...
							<li class="active">
								<!-- 
								<a href="/admin/board/listAll?page=1">1</a>
								<a href="/admin/board/listAll?page=1&perPageNum=10">1</a>
								-->
								<a href="/admin/board/listAll?page=1&amp;perPageNum=10&amp;searchType&amp;keyword">1</a>
							</li>
